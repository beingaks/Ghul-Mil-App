...
const CommentsModal = ({ onBackDropPress , comments, isVisible}) => {
    ...
    return (
      <View style = {styles.commentContainer}>
        <View style = {styles.commentAuthorContainer}>
          ...
          <Text style = {styles.emailText}>{item?.commenter?.email}</Text>
        </View>
        <View>
      ...
      <View style={styles.container}>
        {
          ...
          <View style = {styles.noCommentContainer}>
            <Text style = {styles.noCommentText}>No comments to show</Text>
          </View>
        }
      </View>
    </ModalContainer>
